...
<TABLE cellSpacing=0 cellPadding=0 width="120%" align=center border=1>
    ...
    <TD align="center"> 
  	...
  	<a href="${url2 }update30.action?id=${bean.id }">查看回复内容</a> &nbsp; &nbsp; &nbsp;

  	<a href="${url2 }delete10.action?id=${bean.id }">删除回复</a>&nbsp; &nbsp; &nbsp;
  	
 
 
 	<a href="method!cainadelete.action?huifuid=${bean.id }"  onclick="return confirm('确认采纳吗？');">确认采纳</a>
