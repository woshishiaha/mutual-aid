...
<TABLE cellSpacing=0 cellPadding=0 width="120%" align=center border=1>
  	...
  	<TR >
    <TD align="center" >求助帖子标题</TD>
    
    <TD align="center" >采纳时间</TD>
    <TD align="center" >求助者确认完成状态</TD>
    <TD align="center" >帮助者确认完成状态</TD>
    ...
    <TR >
    <TD align="center" >${bean.huifu.tiezi.title }</TD>
 
    <TD align="center" >${bean.ctime }</TD>
    <TD align="center" >${bean.status1 }</TD>
    <TD align="center" >${bean.status2 }</TD>
	...
	<c:if test="${bean.status2=='未确认'}">
  	<a href="${url2 }delete3.action?id=${bean.id }">确认完成</a>
 	</c:if>
 
 	<c:if test="${bean.status2=='确认完成'}">
 	<c:if test="${bean.status1=='确认完成'}"><c:if test="${bean.pj2==null}">
  	<a href="${url2 }update3.action?id=${bean.id }">评价</a>
 	</c:if></c:if></c:if>
