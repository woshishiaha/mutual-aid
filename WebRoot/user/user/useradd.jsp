...
${bean.huifushu }
   ...
   <input  name="uploadfile"  type="file"  />
    ...
    <TD align="center"> 
     <input  type="text" name="lianxifangshi"   size="30"  value="${bean.lianxifangshi }" />
    ...
    <TD align="center">  <textarea class="InputCss" rows="7" cols="50" name="jianjie">${bean.jianjie }</textarea>
