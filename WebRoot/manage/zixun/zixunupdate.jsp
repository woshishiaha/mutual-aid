...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
    ...
    <TD align="center"> 
    <input  type="text" name="ztitle"  id='ztitleid'  size="30"  value="${bean.ztitle }" />
    ...
    <TD align="center">  <textarea class="InputCss" rows="7" cols="50" name="zcontent">${bean.zcontent }</textarea>
