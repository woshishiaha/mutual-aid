...
function checkform()
{
	...
	if (document.getElementById('ztitleid').value=="")
	{
		alert("资讯标题不能为空");
		return false;
	}
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
  	...
  	<TR height=>
    <TD align="center" >资讯标题:</TD>
    <TD align="center"> 
    <input  type="text" name="ztitle"  id='ztitleid'  size="30"  value="${bean.ztitle }"  readonly="readonly" />
    ...
    <TD align="center">  <textarea class="InputCss" rows="7" cols="50" name="zcontent" readonly="readonly">${bean.zcontent }</textarea>
