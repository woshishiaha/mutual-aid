...
<a href="${url2 }add.action"><span style="font-size: 15px;font-weight: bold;">添加资讯</span></a>
资讯标题：<input name="ztitle" type="text"  value="${ztitle }">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
    ...
    <TR >
    <TD align="center" >${bean.ztitle }</TD>
